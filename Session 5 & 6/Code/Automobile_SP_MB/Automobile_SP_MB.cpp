...
const int LINE_FOLLOWING_BASESPEED = 22;
...
const double SHORTCUT_BLUE_BASESPEED = 22;
const double SHORTCUT_GREEN_BASESPEED = 22;
const double SHORTCUT_RED_BASESPEED = 22;
const double SHORTCUT_YELLOW_BASESPEED = 22;
...
State CheckOperation()
{
    ...
    Mat symbolMat = originalMatTransformed(symbolTargetRect);
